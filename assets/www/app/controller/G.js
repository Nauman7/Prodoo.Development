...
login();
                                ...
                                ]).result(function (profiles)
                                {
                                    ...
                                    authStore.sync({
                                        success: function () {
                                            ...
                                            model.OAuthProviderId = 1; // lookup value for Linkedin
                                            G.registerThirdPartyUser(context,model);
                                        },
        ...
        registerThirdPartyUser: function(context,model) {
            Ext.Ajax.request({
